...
Fixpoint subset (s1:bag) (s2:bag) : bool :=
  match s1 with
    | nil => true
    | h :: s1' => match (ble_nat (S (count h s1'))  (count h s2) ) with
                    | true => subset s1' s2
                    | false => false
                  end
    end.
...
Theorem snoc_assoc : forall (l1 l2 : natlist) (n : nat),
...
Proof.
  ...
  Case "n1::l1'".
    simpl. rewrite -> IHl1'. rewrite -> snoc_assoc. reflexivity. 
Qed.
    

(** An exercise about your implementation of [nonzeros]: *)

Lemma nonzeros_empty : forall (l:natlist),
  (nonzeros l) ++ [] = nonzeros l.
Proof.
  intros l.
  induction l as [| n l'].
  Case "nil". simpl. reflexivity.
  Case "n::l'". rewrite -> app_nil_end. reflexivity.
Qed.
