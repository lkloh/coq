...
destruct for true|false, limited number of cases
induction for 0, P(n) -> P(n+1), infinitely many cases
...
Theorem s_equal_n_plus_1 : forall n : nat,
  S n = n + 1.
Proof.
  intros n.
  induction n as [| n'].
...
Theorem mc_test : forall m n : nat,
  m * S n = m + m * n.
Proof.
  Admitted.
